  ...
  return (
    <div className="brand-theme space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-card p-6 rounded-2xl border border-border bg-card/40 backdrop-blur-xl">
          <h2 className="text-lg font-semibold text-foreground mb-4">Conversão: Grátis vs Assinantes</h2>
          <div className="h-64">
        ...
        <div className="glass-card p-6 rounded-2xl border border-border bg-card/40 backdrop-blur-xl flex flex-col justify-center items-center text-center">
          ...
          <div className="text-4xl font-black text-foreground mt-2">R$ {totalAssinantes * 9},90</div>
